namespace GleyGameServices
{
    ...
    public class GameServicesSettingsWindow : EditorWindow
    {
        ...
        [MenuItem("Window/Gley/Game Services")]
        private static void Init()
        {
            // Get existing open window or if none, make a new one:
            GameServicesSettingsWindow window = (GameServicesSettingsWindow)GetWindow(typeof(GameServicesSettingsWindow), true, "Game Services Settings Window - v1.2.2");
        ...
        private void OnGUI()
        {
            ...
            usePlaymaker = EditorGUILayout.Toggle("Use Playmaker", usePlaymaker);
        ...
        public static void CreateAdSettings()
        {
            ...
            if (!AssetDatabase.IsValidFolder("Assets/GleyPlugins/GameServices/Resources"))
            {
                AssetDatabase.CreateFolder("Assets/GleyPlugins/GameServices", "Resources");
                AssetDatabase.Refresh();
            }

            AssetDatabase.CreateAsset(asset, "Assets/GleyPlugins/GameServices/Resources/GameServicesData.asset");
        ...
        {
            if (!AssetDatabase.IsValidFolder("Assets/GleyPlugins/GameServices/Plugins"))
            {
                AssetDatabase.CreateFolder("Assets/GleyPlugins/GameServices", "Plugins");
                AssetDatabase.Refresh();
                AssetDatabase.CreateFolder("Assets/GleyPlugins/GameServices/Plugins", "Android");
                AssetDatabase.Refresh();
                AssetDatabase.CreateFolder("Assets/GleyPlugins/GameServices/Plugins/Android", "GameServicesManifest.plugin");
                AssetDatabase.Refresh();
            }
            ...
            File.WriteAllText(Application.dataPath + "/GleyPlugins/GameServices/Plugins/Android/GameServicesManifest.plugin/AndroidManifest.xml", text);

            text = "target=android-16\nandroid.library = true";
            File.WriteAllText(Application.dataPath + "/GleyPlugins/GameServices/Plugins/Android/GameServicesManifest.plugin/project.properties", text);
            AssetDatabase.Refresh();
            ...
            {
                ((PluginImporter)PluginImporter.GetAtPath("Assets/GleyPlugins/GameServices/Plugins/Android/GameServicesManifest.plugin")).SetCompatibleWithAnyPlatform(false);
                ((PluginImporter)PluginImporter.GetAtPath("Assets/GleyPlugins/GameServices/Plugins/Android/GameServicesManifest.plugin")).SetCompatibleWithPlatform(BuildTarget.Android, false);
            }
            AssetDatabase.Refresh();
        }
        ...
        private void CreateEnumFiles()
        {
            ...
            text += "}";
            File.WriteAllText(Application.dataPath + "/GleyPlugins/GameServices/Scripts/AchievementNames.cs", text);
            ...
            text += "}";
            File.WriteAllText(Application.dataPath + "/GleyPlugins/GameServices/Scripts/LeaderboardNames.cs", text);
